...
const AUTHORED_PROCEDURE_DEFINITIONS: Readonly<Record<string, ProcedureDefinition>> = {
  ...
  "gesture.count_two": p("gesture.count_two", 0.7, "actor", "present exactly two fingers for a quantity reveal", handR, [["one", "raise the index finger", "out"], ["two", "add the middle finger and hold the count", "io"]]),
